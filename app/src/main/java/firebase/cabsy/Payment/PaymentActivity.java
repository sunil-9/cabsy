package firebase.cabsy.Payment;
...
import firebase.cabsy.Common.Common;
...
import static firebase.cabsy.Common.ApplicationContext.getContext;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    private void requestPickupHere() {
        ...
        firebase.cabsy.models.Request request = new firebase.cabsy.models.Request(userID, profile_photo2, profile_photo, username, 1, destination, currentLocation, 1, false, rideID, dateOnly, pickupTime,   Float.parseFloat(cost.substring(2)), pickupLocation, licencePlate);
